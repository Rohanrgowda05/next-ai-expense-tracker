...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className='relative w-14 h-8 bg-gradient-to-r from-indigo-200/80 to-blue-200/80 dark:from-indigo-900/80 dark:to-blue-900/80 hover:from-indigo-300/80 hover:to-blue-300/80 dark:hover:from-indigo-800/80 dark:hover:to-blue-800/80 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl border border-indigo-200/50 dark:border-indigo-700/50 transition-all duration-300 group'
      ...
      <div
        className={`absolute top-0.5 w-7 h-7 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center transition-all duration-300 transform group-hover:scale-110 ${
          theme === 'light'
            ...
            : 'left-6 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-700 dark:to-gray-800'
        }`}
      >
        <span
