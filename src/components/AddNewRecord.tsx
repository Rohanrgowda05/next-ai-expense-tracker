...
const AddRecord = () => {
  ...
  <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
    <div className='w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-indigo-500 via-blue-500 to-sky-500 rounded-xl flex items-center justify-center shadow-lg'>
...
<button
  type='submit'
  className='w-full relative overflow-hidden bg-gradient-to-r from-indigo-600 via-blue-500 to-sky-500 hover:from-indigo-700 hover:via-blue-600 hover:to-sky-600 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-xl font-semibold shadow-xl hover:shadow-2xl group transition-all duration-300 border-2 border-transparent hover:border-white/20 text-sm sm:text-base'
  disabled={isLoading}
>
...
{alertMessage && (
  <div
    className={`mt-4 p-3 rounded-xl border-l-4 backdrop-blur-sm ${
      alertType === 'success'
        ? 'bg-indigo-50/80 dark:bg-indigo-900/20 border-l-indigo-500 text-indigo-800 dark:text-indigo-200'
